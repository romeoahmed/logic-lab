...
| Workspace | `authentication_required`, `forbidden`, `workspace_not_found`, `workspace_expired`, `stale_workspace_attachment`, `idempotency_key_conflict`, `idempotency_window_expired`, `project_revision_precondition_failed`, `projection_version_precondition_failed`, `session_precondition_failed`, `run_generation_precondition_failed`, `operation_precondition_failed`, `durable_save_conflict`, `build_fingerprint_mismatch`, `hot_swap_incompatible`, `workspace_admission_rejected`, `workspace_cancelled`, `workspace_infrastructure_failure`, `workspace_internal_defect`, `operation_expired`, `proposal_stale`, `export_expired`, `analysis_not_applicable` |
