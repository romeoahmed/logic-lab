...
| 39 | Calibrate Browser Policy and frame evidence | 34, 37, 38 | Intent and snapshot sizes, bitmap and cache allocations, frame/long-task distributions, and idle behavior establish versioned browser limits plus independently justified observation evidence; unused threshold fields are not added speculatively. |
