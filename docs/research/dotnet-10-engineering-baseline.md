...
The dated pre-migration inventory, implementation result, and review obligations are recorded once in [TUnit Modern Testing Research](./tunit-modern-testing.md#2-pre-migration-logic-lab-baseline).
