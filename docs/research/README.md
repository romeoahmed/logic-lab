...
| [.NET Platform](./dotnet-platform.md)                           | SDK, dependencies, hosting, persistence, and publication evidence                |
...
Keep dated measurements and source snapshots only while they support a live decision. Remove completed migration inventories, superseded setup instructions, and implementation-status snapshots; executable configuration and the Implementation Plan own current facts.
