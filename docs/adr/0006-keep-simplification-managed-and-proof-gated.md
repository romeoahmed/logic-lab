...
If Boolean Analysis is reactivated, it uses a self-developed managed .NET design:
...
libraries, and algorithm NuGet packages remain research-only. At most one verified
