...
|---|---|---|---|
| authoring, Compilation, Simulation, analysis, format, diagnostics, symbols | closed V1 behavior and Module interfaces | immutable lineage; the closed V1 Edit Intent catalog with atomic public-Port and instance-contract migration, deletion, Memory Images, Symbol Profile/Variant, and ordered Annotations; explicit Net/Junction/Wire Geometry editing; Domain-resolved generated split/concat and arithmetic Ports; zero/sign extension, constant-source, unsigned comparison, full-adder/subtractor, and logical-shift execution; bounded unknown shift-case settlement; hierarchical combinational Compilation with complete occurrence provenance and recursion evidence; cyclic combinational Least Information Fixed Point settlement with synchronous-oracle differential, Indeterminate Feedback, contention, defect, exhaustion, and epoch-reset evidence; atomic Simulation Session, diagnostics, scalar oracle, and packed differential path | remaining sequential and memory Runtime breadth, Boolean Analysis, Project Format, TeachingMixed geometry generation, and their conformance suites |
