...
{
    public static IEnumerable<Func<SymbolNotationExpectation>> NotationExpectations()
    {
        yield return () => new SymbolNotationExpectation(
            "sequential.d_latch",
            ["1D", "C1"],
            ["3.3-13", "4.3.7", "5.9"],
            ["Q"]);
...
internal sealed record SymbolNotationExpectation(
    string ContractId,
