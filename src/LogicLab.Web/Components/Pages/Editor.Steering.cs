...
{
    private Task AuthorSteeringExample() => AuthorStarterCircuit(StarterCircuitCatalog.Steering);

    private Task AuthorArithmeticExample() => AuthorStarterCircuit(StarterCircuitCatalog.Arithmetic);
